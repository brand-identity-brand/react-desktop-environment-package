...
const buttons = {
    ...
    fullscreenExit: <span className={'material-symbols-outlined rde-material-symbols-outlined'} style={{fontSize:'12px'}}>{'fullscreen_exit'}</span>,
    fullscreen: <span className={'material-symbols-outlined rde-material-symbols-outlined'} style={{fontSize:'12px'}}>{'fullscreen'}</span>,
    close: <span className={`material-symbols-outlined rde-material-symbols-outlined ${css.close_span}`} >{'close'}</span>,
    collapsed: <span className={'material-symbols-outlined rde-material-symbols-outlined'}>{'navigate_next'}</span>,
